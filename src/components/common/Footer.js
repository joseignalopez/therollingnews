...
const Footer = () => {
  return (
    <div>
      <section className="rojo py-4">
        <div className="text-center row text-light">
          <div className="col-sm-12 col-md-4 text-center list-unstyled mb-4">
          ...
          <div className="col-sm-12 col-md-4 text-center sm-mb-4">
            <img src="IMG-20200909-WA0004.jpg" className="w-75" alt="The Rolling Times"/>
          ...
          <div className="col-sm-12 col-md-4 text-center list-unstyled"> 
