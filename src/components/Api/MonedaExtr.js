  ...
  const consultarDolar = async () => {
    ...
    return (
        ...
        <section className="row ">
          <Card className="col-sm-12 col-md-6 col-lg-3 col-xl-3 p-0">
            <Card.Body>
              <h5 className="p-0">{precio[0] && precio[0].type}</h5>
              <Card.Text className="p-0">
                {precio[0] && precio[0].sellTitle}:{" "}
                {precio[0] && precio[0].sellPrice}
              </Card.Text>
              <Card.Text className="p-0"></Card.Text>
